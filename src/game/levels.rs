...
pub const PAPER_NOTE_13: &str = "..............Объявление!.............. Студенты, не сдавшие сессию, повешены на третьем этаже главного корпуса.";
pub const PAPER_NOTE_14: &str = "..............Объявление!.............. Студенты, не сдающие верхнюю одежду в гардероб, будут повешены на третьем этаже гланого корпуса.";
...
impl Level {
    pub fn new(number: u8, name: &str) -> Self {
        ...
        let (field, player_x, player_y, player_dir, enemies) = match number {
            ...
            4 => Self::create_level_4(&paper_note_13, &paper_note_14),
    ...
    fn create_level_4(paper_note_13: &str, paper_note_14: &str) -> 
        ([[Cell; FIELD_WIDTH]; FIELD_HEIGHT], usize, usize, SideOfTheWorld, Vec<crate::game::Enemy>) {
